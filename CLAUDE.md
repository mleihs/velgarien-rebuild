...
backend/              FastAPI application
  ...
  routers/            API endpoints — 32 routers, 255 endpoints (/api/v1/... + /api/v1/public/... + /api/v1/admin/...)
...
| `docs/05_API_SPECIFICATION.md` | 255 endpoints with request/response formats | v2.0 |
