-- =============================================================================
-- MIGRATION 017: The Capybara Kingdom — Sunless Sea / Failbetter Style Simulation
-- =============================================================================
-- Identical to seed 009. Creates the Capybara Kingdom simulation for deployed DBs.
-- =============================================================================
...
RAISE NOTICE 'Migration 017: Capybara Kingdom complete';
END $$;
